module spaceship/pocketbase-module

go 1.23

require (
	github.com/pocketbase/dbx v1.10.1
	// KEEP WITHIN VERSION 0.22.x!!!!
	// Version 0.23+ is way too different.
	// To limit updates to patches within the 0.22.x series:
	// RUN go get github.com/pocketbase/pocketbase@v0.22
